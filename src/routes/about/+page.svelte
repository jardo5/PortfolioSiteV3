...
<div in:fade="{{duration: 2000}}" class="h-screen w-full font-FiraCode mt-12 text-white flex flex-col items-center gap-12">
    <div class="text-center">
        <h2 class="text-5xl font-bold">A Little Bit About Me</h2>
    </div>
    <section class="h-1/2 w-full flex flex-row justify-center gap-4 flex-wrap ">
        <div id="card" class="h-1/2 w-1/3 text-center py-2 px-4">
            <h1 class="text-2xl underline">Professional</h1>
            <h2 class="">
                I am currently a Fiber Optic Technician, while also studying in school. 
                I'm earning my Bachelor of Science in Software Development at Western Governors University.
                I'm eager to learn new skills to further my abilities in software engineering.
            </h2>
        </div>
        <div id="card" class="h-1/2 w-1/3 text-center py-2 px-4">
            <h1 class="text-2xl underline">Personal</h1>
            <h2 class="">
                I'm an avid movie watcher, <span class="underline">some</span> of my favorites are Interstellar, Tenet, Inception, Shutter Island, Triangle, and Seven.
                I also enjoy playing video games, my favorites are Call of Duty, Counter Strike, and The Last of Us.
                If I'm not doing either of these, I'm most likely creating new projects to further my skills.
            </h2>
        </div>
        <div id=card class="w-1/2 h-fit p-4 justify-center flex flex-col gap-2">
            <h1 class="text-2xl underline text-center">Skills</h1>
            <div class="w-full h-full flex justify-center">
                <ul class="w-3/5 h-1/3 flex flex-row flex-wrap gap-1">
                    <li>
                        <!--SVG SPAM-->
                        <span class="cursor-pointer flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#bc3c1881] hover:border-[#bc3c18]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class=""> 
                                <path d="M12,17.56L16.07,16.43L16.62,10.33H9.38L9.2,8.3H16.8L17,6.31H7L7.56,12.32H14.45L14.22,14.9L12,15.5L9.78,14.9L9.64,13.24H7.64L7.93,16.43L12,17.56M4.07,3H19.93L18.5,19.2L12,21L5.5,19.2L4.07,3Z" style="fill:currentColor"></path>
                            </svg>
                            HTML5
                        </span>
                    </li>
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#3573b556] hover:border-[#3572b5]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="">
                                <path d="M5,3L4.35,6.34H17.94L17.5,8.5H3.92L3.26,11.83H16.85L16.09,15.64L10.61,17.45L5.86,15.64L6.19,14H2.85L2.06,18L9.91,21L18.96,18L20.16,11.97L20.4,10.76L21.94,3H5Z" style="fill:currentColor">\
                                </path>
                            </svg>
                            CSS3
                        </span>
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#f7de1e54] hover:border-[#f7df1e]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#bc3c1881] hover:border-[#bc3c18]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#3573b556] hover:border-[#3572b5]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="snipcss0-3-21-22">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#62af436c] hover:border-[#61af43]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="snipcss0-3-30-31">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#00000080] hover:border-[#000000]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="snipcss0-3-36-37">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#62af436c] hover:border-[#61af43]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="snipcss0-3-33-34">
                                <path d="M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5C2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z" style="fill:currentColor">
                                </path>
                            </svg>
                            MongoDB
                        </span>
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#bc3c1881] hover:border-[#bc3c18]">
                            <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation" class="snipcss0-3-45-46">
                    ...
                    <li>
                        <span class="flex items-center justify-center p-4 h-6 rounded-2xl gap-1 w-fit border transition ease-in-out delay-100 hover:bg-[#3573b556] hover:border-[#3572b5]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M10.5 20h3q.2 0 .35-.15t.15-.35q0-.2-.15-.35T13.5 19h-3q-.2 0-.35.15t-.15.35q0 .2.15.35t.35.15ZM7 23q-.825 0-1.413-.588T5 21V3q0-.825.588-1.413T7 1h10q.825 0 1.413.588T19 3v18q0 .825-.588 1.413T17 23H7Zm0-7h10V6H7v10Zm0 2v3h10v-3H7ZM7 4h10V3H7v1Zm0-1v1v-1Zm0 18v-3v3Z"/>
                            </svg>
                            Responsive Design
                        </span>
                    </li>
